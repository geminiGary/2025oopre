...
public class MainClassTest {
    ...
    public void addBottle() {
        ...
        MainClass.addRelation("kkrAw9eM", "64Vr5");
        MainClass.addRelation("64Vr5", "kkrAw9eM");
        MainClass.use("8fgmjnrEaD5VSrSGgZ", "1YRzknTLTl1XPjO", "kkrAw9eM");
        MainClass.fight("kkrAw9eM", new ArrayList<>(Arrays.asList(adventurer6, adventurer8, adventurer7)));
        MainClass.removeRelation("kkrAw9eM", "64Vr5");
        MainClass.fight("kkrAw9eM", new ArrayList<>(Arrays.asList(adventurer6)));
        MainClass.addRelation("kkrAw9eM", "64Vr5");
        MainClass.addBottle("hFQ75F27_LHYfVzyoXx", "CJFAckE0t2nsDMNWw1NZo", "DefBottle", 1000);
        MainClass.use("hFQ75F27_LHYfVzyoXx", "CJFAckE0t2nsDMNWw1NZo", "hFQ75F27_LHYfVzyoXx");
        //300
        //aa   kkrAw9eM
