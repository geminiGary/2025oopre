...
public class MainClass {
        ...
        for (int a = 0;a < n;a++) {
            ...
            switch (type) {
                ...
                case "ae":
                    ...
                    break;
                case "ls":
                    learnSpell(input.next(),input.next(),input.next(),
                ...
                case "fight":
                    ...
                    break;
                case "ar":
                    addRelation(input.next(),input.next());
                    break;
                case "rr":
                    removeRelation(input.next(),input.next());
                    break;
                case "lr":
                    loadRelation(input.next());
                    break;
                default:
                    break;
            }
    ...
    public static void addRelation(String adventurerName,String targetName) {
        for (Adventurer adventurer:adventurers) {
            if (adventurer.getName().equals(adventurerName)) {
                if (adventurer.isAlive())
                {
                    for (Adventurer advTarget:adventurers) {
                        if (advTarget.getName().equals(targetName)) {
                            if (advTarget.isAlive())
                            {
                                adventurer.addRelation(advTarget);
                            }
                            else
                            {
                                System.out.println(targetName + " is dead!");
                            }
                            break;
                        }
                    }
    ...
    public static void removeRelation(String adventurerName,String targetName) {
        for (Adventurer adventurer:adventurers) {
            if (adventurer.getName().equals(adventurerName)) {
                if (adventurer.isAlive())
                {
                    for (Adventurer advTarget:adventurers) {
                        if (advTarget.getName().equals(targetName)) {
                            if (advTarget.isAlive())
                            {
                                adventurer.removeRelation(advTarget);
                            }
                            else
                            {
                                System.out.println(targetName + " is dead!");
    ...
    public static void loadRelation(String input) {
